...
export const imageRender = (
  ...
  if (block.props.url === "") {
    ...
    container.className = "bn-visual-media";
    //editor.resolveFileUrl(block.props.url).then((downloadUrl) => {
    container.innerHTML = block.props.url;
    //});
...
export const imageToExternalHTML = (
  ...
  if (block.props.showPreview) {
    ...
    image.innerHTML = block.props.url;
    /* image.alt = block.props.name || block.props.caption || "BlockNote image";
...
const parseImageElement = (imageElement: HTMLImageElement) => {
...
export const HtmlBlock = createBlockSpec(imageBlockConfig, {
  render: imageRender,
  parse: imageParse,
